  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'src/api/hotkey/command.cc',
        'src/api/hotkey/command.h',
        'src/api/hotkey/hotkey.cc',
        'src/api/hotkey/hotkey.h',
        'src/api/hotkey/global_hotkey_manager.cc',
        'src/api/hotkey/global_hotkey_manager.h',
        'src/api/hotkey/global_hotkey_manager_win.cc',
        'src/api/hotkey/hotkey_constants.cc',
